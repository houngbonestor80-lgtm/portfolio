...
if (!$product) {
    ...
    echo '<div class="empty-state"><div class="icon">&#128269;</div><h3>Produit introuvable</h3><p>Ce produit n\'existe plus ou a ete retire de la boutique.</p><a href="/shop.php" class="btn btn-primary">Retour a la boutique</a></div>';
            ...
            <div class="product-info">
                ...
                <p class="stock-line">
                    ...
                    <?php elseif ($product['stock'] <= 5): ?>
                        <span class="stock-low">&#9888; Plus que <?= (int) $product['stock'] ?> en stock</span>
                    <?php else: ?>
